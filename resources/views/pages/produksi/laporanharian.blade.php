...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><b>DATA LAPORAN HARIAN</b></h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">
                                <button type="button" class="btn btn-outline-primary btn-sm btn-tambahLaporan"><i
                                        class="fa fa-plus"></i>
                                    TAMBAH LAPORAN HARIAN</button>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="tableLaporanHarian" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>TANGGAL</th>
                ...
                <form id="storeLaporanHarian" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="laporan" id="laporan" style="height: 300px"></textarea>
                        </div>
                    </div>
    ...
    <script src="{{ asset('assets') }}/js/laporanharian.js"></script>
